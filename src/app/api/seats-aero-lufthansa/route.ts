...
export async function GET(req: NextRequest) {
  try {
    ...
    // Define routes: Lufthansa hubs to destinations and destinations to Lufthansa hubs
    const routes = [
      // Lufthansa hubs to destinations
      'MUC/FRA-',
      // Destinations to Lufthansa hubs
      '-MUC/FRA'
    ];
        ...
        for (const item of rawData.data) {
          if (item.AvailabilityTrips && Array.isArray(item.AvailabilityTrips)) {
            for (const trip of item.AvailabilityTrips) {
              ...
              // Filter to only include LH flights
              if (trip.FlightNumbers && !trip.FlightNumbers.startsWith('LH')) {
                console.log('Skipping non-LH flight:', trip.FlightNumbers);
                continue;
              }
              
              console.log('Including LH flight:', trip.FlightNumbers);
    ...
    console.error('Error in /api/seats-aero-lufthansa:', error);
    return NextResponse.json(
